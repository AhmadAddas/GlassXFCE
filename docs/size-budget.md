...
- Internal release target: **1800 MiB** maximum per ISO.
- GitHub Release hard ceiling: treat **2 GiB per asset** as an external limit.
- The 1800 MiB budget leaves headroom for filesystem/bootloader growth and avoids releases that sit directly on the hosting limit.
